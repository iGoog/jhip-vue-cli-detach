    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span class="navbar-title">jhiprel</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/top-record">
                        <font-awesome-icon icon="asterisk" />
                        <span >TopRecord</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/row-record">
                        <font-awesome-icon icon="asterisk" />
                        <span >RowRecord</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/row-record-extra">
                        <font-awesome-icon icon="asterisk" />
                        <span >RowRecordExtra</span>
                    </b-dropdown-item>
...
.logo-img {
  height: 100%;
  background: url("../../../public/images/logo-jhipster.png") no-repeat center
    center;
